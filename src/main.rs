...
fn main() {
    let weight:f32 = 165.8;
    let body_fat_percentage:f32 = 0.115;
    let goal_body_fat_percentage = 0.1;
    let rate_of_weekly_weight_loss = 1.0;
